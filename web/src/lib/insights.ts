...
export const INSIGHT_2026_07: InsightMonth = {
  ...
  warehouse: {
    ...
    peakBacklogNote:
      "ช่วงปลายเดือน (27–31 ก.ค.) มีออเดอร์ค้างส่งพุ่งสูงสุด 1,000+ ออเดอร์/วัน (รวม U5/U15 เกือบ 2,000 ออเดอร์ใน 5 วัน) — backlog เป็นสาเหตุหลักที่ %ตีกลับพุ่งในมิ.ย.–ก.ค.",
  },
  adminWatch: [
  ...
  emergingIssues: [
    "สินค้าผลิตไม่ทัน — โรงงานผลิตไม่ทันตามยอดสั่งซื้อที่สูงขึ้นจากทุกช่องทาง ส่งผลให้เกิดยอดค้างส่งสะสม",
    "มิจฉาชีพก็อปปีคอนเทนต์/แอบอ้างชื่อบริษัทส่งพัสดุปลอมแบบ COD หลอกเก็บเงินลูกค้า กระทบความเชื่อมั่นและภาพลักษณ์บริษัท",
    "ข้อมูลตัวเลขไม่ตรงกันระหว่างทีมขาย คลังสินค้า และบัญชี — ต้องเร่งปรับให้ตรงกันก่อนประชุมครั้งถัดไป",
  ],
  dataQualityNote:
    "ตัวเลขบางส่วนในรายงานแต่ละฝ่ายไม่ตรงกับสรุปภาพรวม 100% เช่น CRM สนญ. รายงานเอง 1.45% แต่สรุปภาพรวมระบุ 1.61% — ตามที่เลขาระบุในที่ประชุมว่ายังพบความคลาดเคลื่อนระหว่างทีม ควรใช้ตัวเลขจาก Dashboard นี้ (คำนวณจากข้อมูลดิบ) เป็นค่าอ้างอิงหลัก",
  sourceDocs: [
